      ...
      <div class="content-padding">
        <form role="form" method="POST" action="{{ route('event-create') }}" enctype="multipart/form-data">
          ...
          <div class="form-group{{ $errors->has('start_time') ? 'has-error' : '' }}">
            ...
            <input type="text" class="form-control" name="start_time" id="start_time" value="{{ old('start_time') }}" readonly>
          ...
          <div class="form-group{{ $errors->has('twitch_url') ? 'has-error' : '' }}">
            ...
            <input type="url" class="form-control" name="twitch_url" value="{{ old('twitch_url') }}">
            <span class="help-block">
